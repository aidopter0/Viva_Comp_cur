...
Uses parse_line + search_synonym_for_row from key_item_line_parse.py.

Examples:
  python gemini_key_items_builder.py
  python gemini_key_items_builder.py --input config/key_items.txt --output config/key_items_prepared_gemini.json
  python gemini_key_items_builder.py --dry-run   # no API; heuristic fallback from parse_line
"""
...
from key_item_line_parse import glue_weights_in_text, normalize_for_compare, parse_line, search_synonym_for_row
from prepared_key_items_sync import HASH_FILE, KEY_ITEMS_TXT, write_stored_hash
